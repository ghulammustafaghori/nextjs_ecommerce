        ...
        <div>
            <div className=' w-full mt-10 flex flex-col lg:flex-row'>
                <div className=' w-full lg:w-[45%]  flex justify-center '>
                    ...
                    <div className='w-full sm:w-[80%] lg:w-[70%]  rounded-2xl px-10 p-5 md:pb-20  flex lg:block justify-between ' style={{backgroundColor:'#0049a9'}}>
                ...
                <div className='w-full lg:w-1/2 h-full  flex flex-col gap-7 items-center mt-15 lg:mt-0'>
                    ...
                    <div className='w-full sm:w-[80%] lg:w-full   rounded-2xl p-7 bg-gray-100 relative pb-10 md:pb-10 lg:pb-10 pt-10'>
                     ...
                     <div className='w-full sm:w-[80%]  lg:w-full  rounded-2xl p-7 bg-gray-100 relative pb-10 md:pb-10 lg:pb-10 pt-10 mt-8 lg:mt-0'>
